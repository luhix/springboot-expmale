...
public class Constants {
    ...
    public static Integer[] getUserRoleList(List<Role> roleList) {
        ...
        Optional<Role> adminOptinal = roleList.stream().filter(role -> ROLE_ADMIN.equals(role.getRoleName())).findFirst();
        ...
        } else if(adminOptinal.isPresent() && systemadminOptional.isPresent()) {
            return ROLE_SUPERADMIN_LIST;
        } else if(adminOptinal.isPresent()) {
